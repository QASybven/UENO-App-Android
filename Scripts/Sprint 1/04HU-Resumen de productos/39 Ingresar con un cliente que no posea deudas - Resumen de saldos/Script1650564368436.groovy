...
Mobile.sendKeys(findTestObject('Object Repository/Sprint 1/Resumen de productos/android.widget.EditText - Ejemplo 0981123456'), '0982159800')

Mobile.setText(findTestObject('Object Repository/Sprint 1/Resumen de productos/android.widget.EditText (1)'), 'Kony!12345', 0)

Mobile.tap(findTestObject('Object Repository/Sprint 1/Resumen de productos/android.widget.Button - Ingresar (1)'), 0)
